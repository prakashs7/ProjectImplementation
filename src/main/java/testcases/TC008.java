...
public class TC008 extends GenericWrappers{
	...
	@Test(dataProvider="bookHotelsWithoutGST", dataProviderClass=DP008.class)
	public void bookHotelsWithoutGST(String email, String mobileNo,String city,String rooms,String person,String title,String firstName,String lastName,String state,String hotelName,String price) {
		...
		waitProperty(500);
		verifyTextContainsByXpath("/html/body/app-root/app-fulllayout/div/app-paxdetail/main/div/div[2]/div/div/div[1]/span", hotelName);
		verifyTextByXpath("/html/body/app-root/app-fulllayout/div/app-paxdetail/main/div/div[2]/div/div/div[5]/span/b", price);
		...
		verifyTextContainsByXpath("//*[@id=\"OTPModal\"]/div/div/form/div[1]/span", "otp field is required.");
